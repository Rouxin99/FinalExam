...
const products= {
  ...
  c:[
    {name:"分身", image:"../images/goods-img/hunter/doppelganger/doppelganger1.jpg", price:"6,000", details:"分裂即強大！", link:"../index.html"},
    {name:"四次元公寓", image:"../images/goods-img/hunter/fourDimensionsApartment/fourDimensionsApartment1.jpg", price:"180,000", details:"隨時開啟隱秘、安全、便捷的藏身之所！", link:"../index.html" },
    {name:"神的左手惡魔的右手", image:"../images/goods-img/hunter/god'sLeftHand", price:"25,000", details:"簡單觸碰，複製奇蹟！", link:"../index.html"},
    {name:"凸眼魚", image:"../images/goods-img/hunter/popeyeFish/popeyeFish1.png", price:"70,000", details:"能夠吸入任何無生命的物品", link:"../index.html" },
    {name:"鎖鏈", image:"../images/goods-img/hunter/chain/chain1.jpg", price:"30,000", details:"束縛、治療、奪取和審判", link:"../index.html" },
  ],
  d:[
    {name:"四次元公寓", image:"../images/goods-img/hunter/fourDimensionsApartment/fourDimensionsApartment1.jpg", price:"180,000", details:"隨時開啟隱秘、安全、便捷的藏身之所！", link:"../index.html"},
    {name:"七色弓箭", image:"../images/goods-img/hunter/sevenColor/sevenColor1.png", price:"5,000", details:"將自身的氣轉化為弓箭", link:"../index.html" },
    {name:"旋律", image:"../images/goods-img/hunter/melody/melody1.png", price:"6,000", details:"旋律的心靈樂章能夠撫慰人心", link:"../index.html" },
    {name:"雙手機關槍", image:"../images/goods-img/hunter/twoHanded/twoHanded1.png", price:"50,000", details:"雙手十指如機關槍般連續發射念彈", link:"../index.html" },
    {name:"天上不知唯我獨損", image:"../images/goods-img/hunter/theSkyDoesNotKnow/theSkyDoesNotKnow1.jpg", price:"60,000", details:"一種高風險高回報的念能力", link:"../index.html" },
  ],
  e:[
    {name:"紫煙機兵隊", image:"../images/goods-img/hunter/purpleSmoke/purpleSmoke1.jpg", price:"35,000", details:"指揮無敵機兵！", link:"../index.html"},
    {name:"麟粉乃愛泉", image:"../images/goods-img/hunter/scalePowder/scalePowder1.jpg", price:"80,000", dtails:"使用者釋放出特殊的麟粉，影響目標的精神狀態", link:"../index.html" },
    {name:"攜帶他人的命運", image:"../images/goods-img/hunter/carryingTheFate/carryingTheFate1.png", price:"40,000", details:"想要掌控他人的行動嗎？", link:"../index.html"},
    {name:"分身", image:"../images/goods-img/hunter/doppelganger/doppelganger1.jpg", price:"6,000", details:"分裂即強大！", link:"../index.html" },
    {name:"180分的戀愛奴隷", image:"../images/goods-img/hunter/180loveSlave/180loveSlave1.png", price:"60,000", details:"被您親吻過的人將無條件地成為您的忠實追隨者", link:"../index.html" },
  ],
  f:[
    {name:"天使的自動筆記", image:"../images/goods-img/hunter/angel'sAutomaticNotes/angel'sAutomaticNotes1.jpg", price:"60,000", details:"掌握未來，贏在起點！", link:"../index.html"},
    {name:"玩具修理者", image:"../images/goods-img/hunter/toyRepairer/toyRepairer1.jpg", price:"250,000", details:"化不可能為可能的治癒奇蹟！", link:"../index.html"},
    {name:"神的不在場證明&神的共犯", image:"../images/goods-img/hunter/god'sAlibi/god'sAlibi1.jpg", price:"34,000", details:"化身為影子，掌控一切卻無人察覺！", link:"../index.html"},
    {name:"讀取記憶&記憶念彈", image:"../images/goods-img/hunter/readMemory/readMemory1.jpg", price:"50,000", details:"觸摸便知真相，用子彈釋放記憶！", link:"../index.html"},
    {name:"寂寞深海魚", image:"../images/goods-img/hunter/lonelyDeepSeaFish/lonelyDeepSeaFish1.png", price:"40,000", details:"追蹤、監視與情報搜集的無敵工具！", link:"../index.html" },
  ],
};
